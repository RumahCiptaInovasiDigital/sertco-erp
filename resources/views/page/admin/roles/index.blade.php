        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Roles Manage</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <table id="dt_roles" class="table table-bordered align-middle table-row-dashed fs-6 gy-5">
                            <thead>
...
@section('scripts')
    ...
    <script>
        const _URL = "{{ route('admin.roles.getDT') }}";
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function(response) {
                            $("#dt_roles").DataTable().ajax.reload(null, false);
