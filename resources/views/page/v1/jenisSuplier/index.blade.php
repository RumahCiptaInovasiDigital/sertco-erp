...
@section('title', 'Jenis Suplier')
@section('PageTitle', 'Jenis Suplier')
@section('head')
<!-- DataTables -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List Jenis Suplier</h3>
                <div class="float-right d-none d-sm-inline">
                    <a href="{{ route('v1.jenis-suplier.create') }}" class="btn btn-primary btn-block btn-sm">
...
<script>
    const _URL = "{{ route('v1.jenis-suplier.getData') }}";
...
<script>
    function deleteData(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('v1.jenis-suplier.destroy') }}",
                    type: "POST",
                    data: {
                        id: id,
                        _token: "{{ csrf_token() }}",
