    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List of Role/Jabatan</h3>
                <div class="float-right d-none d-sm-inline">
                    <a href="{{ route('v1.role.create') }}" class="btn btn-primary btn-block">
                        <i class="fas fa-plus-circle"></i> New Role/Jabatan
                    </a>
                </div>
            </div>
            <!-- /.card-header -->
...
<script>
    const _URL = "{{ route('v1.role.getData') }}";
