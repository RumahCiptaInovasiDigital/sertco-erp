...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('v1.suplier.store') }}" method="post">
                    @csrf
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kontak" value="{{ old('kontak') }}" id="kontak" placeholder="Masukkan Kontak Suplier">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hp_kontak">No. HP Kontak</label>
                                    <input type="text" class="form-control" name="hp_kontak" value="{{ old('hp_kontak') }}" id="hp_kontak" placeholder="Masukkan No. HP Kontak Suplier" onKeyPress="return goodchars(event,'1234567890',this)">
                                </div>
                            </div>
                        </div>
                        <div class="row">
