...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="dt_type" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Kategori</th>
...
<script>
    const _URL = "{{ route('v1.service.type.getData') }}";
...
<script>
    function deleteData(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('v1.service.type.destroy') }}",
                    type: "POST",
                    data: {
                        id: id,
                        _token: "{{ csrf_token() }}",
                    ...
                    success: function (response) {
                        $("#dt_type").DataTable().ajax.reload(null, false);
