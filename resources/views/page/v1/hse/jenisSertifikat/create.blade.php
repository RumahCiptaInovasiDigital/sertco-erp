...
@section('PageTitle', 'Tambah Jenis Sertifikat')
@section('head')
<!-- Select2 -->
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="{{ route('v1.jenis-sertifikat.index') }}">Jenis Sertifikat</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Jenis Sertifikat</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
