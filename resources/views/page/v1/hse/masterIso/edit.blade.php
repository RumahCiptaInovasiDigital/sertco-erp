...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('v1.master-iso.update', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="petugas" id="petugas" value="{{ $data->petugas }}">
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="tgl_audit">Tanggal Audit<span style="color: #ff0000;">*</span></label>
                                <input type="date" class="form-control" name="tgl_audit" id="tgl_audit" value="{{ $data->tgl_audit }}">
                            </div>
                        </div>
