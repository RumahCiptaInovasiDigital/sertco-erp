...
@section('PageTitle', 'Tambah Barang')
@section('head')
<!-- Select2 -->
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('v1.barang.master.store') }}" method="post">
                    @csrf
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" value="{{ old('nama') }}" id="nama" placeholder="Masukkan Nama Barang">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tgl_perolehan">Tanggal Perolehan <span style="color: #ff0000;">*</span></label>
                                    <input type="date" class="form-control" name="tgl_perolehan" value="{{ old('tgl_perolehan') }}" id="tgl_perolehan" placeholder="Masukkan Tanggal Perolehan">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="deskripsi_barang" value="{{ old('deskripsi_barang') }}" id="deskripsi_barang" placeholder="Masukkan Deskripsi Barang" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jumlah_barang" value="{{ old('jumlah_barang') }}" id="jumlah_barang" placeholder="Masukkan Jumlah Barang" onKeyPress="return goodchars(event,'1234567890',this)">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="satuan_barang" id="satuan_barang">
                                        ...
                                        @foreach ($satuan as $item)
                                            <option value="{{ $item->id_satuan_barang }}">{{ $item->satuan }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="kategori_barang" id="kategori_barang">
                                        ...
                                        @foreach ($kategori as $item)
                                            <option value="{{ $item->id_kategori_barang }}">{{ $item->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status_barang" id="status_barang">
                                        ...
                                        <option value="4">Digunakan</option>
                                        <option value="5">Dipinjam</option>
                                        <option value="6">Diperbaiki</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status_kepemilikan" id="status_kepemilikan">
                                        <option value="" disabled selected>-- pilih salah satu --</option>
                                        <option value="1">Sertco Quality</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="last_maintenance" value="{{ old('last_maintenance') }}" id="last_maintenance" placeholder="Masukkan Terakhir Maintenance">
                                </div>
                            </div>
                        </div>
                        <div class="row">
